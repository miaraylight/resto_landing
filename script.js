...
const menuData = 
 ...
 const menuContainer = document.getElementById("menu-content");
    ...
    function capitalize(str) {
      if (!str) return '';
      // This logic correctly capitalizes strings like "Appetizers & Soups"
      if (str.includes(' & ')) {
    ...
    function createNavButtons() {
        ...
        categories.forEach(category => {
            ...
            // Use the original key for the dataset
            button.dataset.category = category; 
            // Use the capitalized version for the display text
    ...
    // 1. Create the navigation buttons dynamically
    createNavButtons();

    // 2. Add a single event listener to the parent container (Event Delegation)
    ...
    // 3. Render the initial category when the page loads
    ...
    if (firstCategory) {
        ...
        // Render the first category's menu
